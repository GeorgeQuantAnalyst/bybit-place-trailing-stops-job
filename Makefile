...
APP_LOG_FOLDER="${HOME}/log/bybit_place_trailing_stops_job"
...
run:
	@echo "Run ..."
	. venv/bin/activate && ${PYTHON} -m bybit_place_trailing_stops_job

clean:
	@echo "Cleaning ..."
	rm -rf dist
	rm -rf bybit_place_trailing_stops_job.egg-info
	rm -rf venv